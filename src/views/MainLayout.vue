...
<template>
  <div class="tmx-shell">
    <aside class="tmx-sidebar" :class="{compact: compactSidebar}" :style="{width: compactSidebar ? '72px' : '210px'}">
      ...
      <div class="tmx-sidebar-footer">Control what Time Machine backs up<br /><span>v0.3.0</span></div>
    </aside>
...
.sidebar-toggle{flex:0 0 auto}.compact-toggle{position:absolute;right:0;top:56px}.tmx-sidebar.compact{padding-left:8px;padding-right:8px}.tmx-sidebar.compact .tmx-brand{justify-content:center;padding-left:0;padding-right:0}.tmx-sidebar.compact .tmx-menu :deep(.el-menu-item){justify-content:center;padding-left:0!important;padding-right:0!important}.tmx-sidebar.compact .tmx-menu :deep(.el-icon){margin-right:0}
